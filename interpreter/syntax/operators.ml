...
let f32_sqrt_ceil = Unary (F32 F32Op.SqrtCeil)
let f32_sqrt_floor = Unary (F32 F32Op.SqrtFloor)
let f32_sqrt_trunc = Unary (F32 F32Op.SqrtTrunc)
...
let f64_sqrt_ceil = Unary (F64 F64Op.SqrtCeil)
let f64_sqrt_floor = Unary (F64 F64Op.SqrtFloor)
let f64_sqrt_trunc = Unary (F64 F64Op.SqrtTrunc)
...
let f32_add_ceil = Binary (F32 F32Op.AddCeil)
let f32_add_floor = Binary (F32 F32Op.AddFloor)
let f32_add_trunc = Binary (F32 F32Op.AddTrunc)
let f32_sub = Binary (F32 F32Op.Sub)
let f32_sub_ceil = Binary (F32 F32Op.SubCeil)
let f32_sub_floor = Binary (F32 F32Op.SubFloor)
let f32_sub_trunc = Binary (F32 F32Op.SubTrunc)
let f32_mul = Binary (F32 F32Op.Mul)
let f32_mul_ceil = Binary (F32 F32Op.MulCeil)
let f32_mul_floor = Binary (F32 F32Op.MulFloor)
let f32_mul_trunc = Binary (F32 F32Op.MulTrunc)
let f32_div = Binary (F32 F32Op.Div)
let f32_div_ceil = Binary (F32 F32Op.DivCeil)
let f32_div_floor = Binary (F32 F32Op.DivFloor)
let f32_div_trunc = Binary (F32 F32Op.DivTrunc)
...
let f64_add_ceil = Binary (F64 F64Op.AddCeil)
let f64_add_floor = Binary (F64 F64Op.AddFloor)
let f64_add_trunc = Binary (F64 F64Op.AddTrunc)
let f64_sub = Binary (F64 F64Op.Sub)
let f64_sub_ceil = Binary (F64 F64Op.SubCeil)
let f64_sub_floor = Binary (F64 F64Op.SubFloor)
let f64_sub_trunc = Binary (F64 F64Op.SubTrunc)
let f64_mul = Binary (F64 F64Op.Mul)
let f64_mul_ceil = Binary (F64 F64Op.MulCeil)
let f64_mul_floor = Binary (F64 F64Op.MulFloor)
let f64_mul_trunc = Binary (F64 F64Op.MulTrunc)
let f64_div = Binary (F64 F64Op.Div)
let f64_div_ceil = Binary (F64 F64Op.DivCeil)
let f64_div_floor = Binary (F64 F64Op.DivFloor)
let f64_div_trunc = Binary (F64 F64Op.DivTrunc)
...
let f32_convert_ceil_i32_s = Convert (F32 F32Op.ConvertCeilSI32)
let f32_convert_floor_i32_s = Convert (F32 F32Op.ConvertFloorSI32)
let f32_convert_trunc_i32_s = Convert (F32 F32Op.ConvertTruncSI32)
let f32_convert_i32_u = Convert (F32 F32Op.ConvertUI32)
let f32_convert_ceil_i32_u = Convert (F32 F32Op.ConvertCeilUI32)
let f32_convert_floor_i32_u = Convert (F32 F32Op.ConvertFloorUI32)
let f32_convert_trunc_i32_u = Convert (F32 F32Op.ConvertTruncUI32)
let f32_convert_i64_s = Convert (F32 F32Op.ConvertSI64)
let f32_convert_ceil_i64_s = Convert (F32 F32Op.ConvertCeilSI64)
let f32_convert_floor_i64_s = Convert (F32 F32Op.ConvertFloorSI64)
let f32_convert_trunc_i64_s = Convert (F32 F32Op.ConvertTruncSI64)
let f32_convert_i64_u = Convert (F32 F32Op.ConvertUI64)
let f32_convert_ceil_i64_u = Convert (F32 F32Op.ConvertCeilUI64)
let f32_convert_floor_i64_u = Convert (F32 F32Op.ConvertFloorUI64)
let f32_convert_trunc_i64_u = Convert (F32 F32Op.ConvertTruncUI64)
...
let f32_demote_ceil_f64 = Convert (F32 F32Op.DemoteCeilF64)
let f32_demote_floor_f64 = Convert (F32 F32Op.DemoteFloorF64)
let f32_demote_trunc_f64 = Convert (F32 F32Op.DemoteTruncF64)
let f64_convert_i32_s = Convert (F64 F64Op.ConvertSI32)
let f64_convert_ceil_i32_s = Convert (F64 F64Op.ConvertCeilSI32)
let f64_convert_floor_i32_s = Convert (F64 F64Op.ConvertFloorSI32)
let f64_convert_trunc_i32_s = Convert (F64 F64Op.ConvertTruncSI32)
let f64_convert_i32_u = Convert (F64 F64Op.ConvertUI32)
let f64_convert_ceil_i32_u = Convert (F64 F64Op.ConvertCeilUI32)
let f64_convert_floor_i32_u = Convert (F64 F64Op.ConvertFloorUI32)
let f64_convert_trunc_i32_u = Convert (F64 F64Op.ConvertTruncUI32)
let f64_convert_i64_s = Convert (F64 F64Op.ConvertSI64)
let f64_convert_ceil_i64_s = Convert (F64 F64Op.ConvertCeilSI64)
let f64_convert_floor_i64_s = Convert (F64 F64Op.ConvertFloorSI64)
let f64_convert_trunc_i64_s = Convert (F64 F64Op.ConvertTruncSI64)
let f64_convert_i64_u = Convert (F64 F64Op.ConvertUI64)
let f64_convert_ceil_i64_u = Convert (F64 F64Op.ConvertCeilUI64)
let f64_convert_floor_i64_u = Convert (F64 F64Op.ConvertFloorUI64)
let f64_convert_trunc_i64_u = Convert (F64 F64Op.ConvertTruncUI64)
let f64_promote_f32 = Convert (F64 F64Op.PromoteF32)
let f64_promote_ceil_f32 = Convert (F64 F64Op.PromoteCeilF32)
let f64_promote_floor_f32 = Convert (F64 F64Op.PromoteFloorF32)
let f64_promote_trunc_f32 = Convert (F64 F64Op.PromoteTruncF32)
