...
struct
  ...
  let unop xx = function
    ...
    | Sqrt -> "sqrt"
    | SqrtCeil -> "sqrt_ceil"
    | SqrtFloor -> "sqrt_floor"
    | SqrtTrunc -> "sqrt_trunc"
  ...
  let cvtop xx = function
    ...
    | ConvertCeilSI32 -> "convert_ceil_i32_s"
    | ConvertFloorSI32 -> "convert_floor_i32_s"
    | ConvertTruncSI32 -> "convert_trunc_i32_s"
    | ConvertUI32 -> "convert_i32_u"
    | ConvertCeilUI32 -> "convert_ceil_i32_u"
    | ConvertFloorUI32 -> "convert_floor_i32_u"
    | ConvertTruncUI32 -> "convert_trunc_i32_u"
    | ConvertSI64 -> "convert_i64_s"
    | ConvertCeilSI64 -> "convert_ceil_i64_s"
    | ConvertFloorSI64 -> "convert_floor_i64_s"
    | ConvertTruncSI64 -> "convert_trunc_i64_s"
    | ConvertUI64 -> "convert_i64_u"
    | ConvertCeilUI64 -> "convert_ceil_i64_u"
    | ConvertFloorUI64 -> "convert_floor_i64_u"
    | ConvertTruncUI64 -> "convert_trunc_i64_u"
    | PromoteF32 -> "promote_f32"
    | PromoteCeilF32 -> "promote_ceil_f32"
    | PromoteFloorF32 -> "promote_floor_f32"
    | PromoteTruncF32 -> "promote_trunc_f32"
    | DemoteF64 -> "demote_f64"
    | DemoteCeilF64 -> "demote_ceil_f64"
    | DemoteFloorF64 -> "demote_floor_f64"
    | DemoteTruncF64 -> "demote_trunc_f64"
